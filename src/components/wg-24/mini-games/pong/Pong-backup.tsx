  ...
  return (
    <div className="flex flex-col p-4 bg-green-900 rounded-lg">
      ...
      <div className="flex justify-between">
        <Badge className="bg-green-500 hover:bg-green-400 ">{scores[0]}</Badge>
        <Badge className="bg-pink-500 hover:bg-pink-400">{scores[2]}</Badge>
      </div>
      <div
        ref={gameBoxRef}
      ...
      >
        ...
        <div
          ...
          className="absolute w-2 h-16 bg-white left-4 top-1/2"
        ...
        <div
          ...
          className="absolute w-2 h-16 bg-white right-4 top-1/2"
          style={{ transform: "translateY(-50%)" }}
        />
